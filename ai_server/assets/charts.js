(function() {
  ...
  // Chart 1: GPU Architecture Evolution & Optical Module Ratio
  var chart1 = echarts.init(document.getElementById('chart-gpu-ratio'), null, { renderer: 'svg' });
  chart1.setOption({
  ...
  // Chart 2: Speed Evolution & Shipment Forecast
  var chart2 = echarts.init(document.getElementById('chart-speed-evolution'), null, { renderer: 'svg' });
  chart2.setOption({
  ...
  // Chart 3: Technology Route Radar
  var chart3 = echarts.init(document.getElementById('chart-tech-radar'), null, { renderer: 'svg' });
  chart3.setOption({
  ...
  // Chart 4: Power Consumption Evolution
  var chart4 = echarts.init(document.getElementById('chart-power-evolution'), null, { renderer: 'svg' });
  chart4.setOption({
  ...
  // Chart 5: Liquid Cooling Penetration
  var chart5 = echarts.init(document.getElementById('chart-liquid-cooling'), null, { renderer: 'svg' });
  chart5.setOption({
  ...
  // Chart 6: Global Optical Module Market Size
  var chart6 = echarts.init(document.getElementById('chart-market-size'), null, { renderer: 'svg' });
  chart6.setOption({
  ...
  // Chart 7: Market Share Pie
  var chart7 = echarts.init(document.getElementById('chart-market-share'), null, { renderer: 'svg' });
  chart7.setOption({
